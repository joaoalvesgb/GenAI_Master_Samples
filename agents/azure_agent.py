"""
=============================================================================
AZURE OPENAI AGENT WITH TOOLS - Agente Azure OpenAI com Ferramentas
=============================================================================

Este agente utiliza o Azure OpenAI Service para conversação com tools.

Azure OpenAI vs OpenAI direto:
- Azure OpenAI: Modelos hospedados na infraestrutura Azure da Microsoft
  com compliance empresarial, SLA, rede privada e controle de dados.
- OpenAI direto: Acesso via api.openai.com
...
class AzureAgent(BaseAgent):
    """
    Agente Azure OpenAI com suporte a Tools, RAG e Memória usando LangGraph.

    Este agente pode:
    - Conversar naturalmente usando modelos implantados no Azure OpenAI
    ...
    Diferença do OpenAI direto:
    - Usa deployments em vez de nomes de modelos
    - Requer endpoint e api_version do Azure
    - Compliance empresarial, SLA e rede privada
    """
    ...
    def __init__(
        self,
        name: str = "Azure OpenAI Assistant",
        description: str = "Assistente IA powered by Azure OpenAI",
        model: str = "gpt-4o",
        ...
        """
        Inicializa o agente Azure OpenAI com parâmetros configuráveis.

        Args:
            name: Nome do agente
            description: Descrição do agente
            model: Nome do deployment no Azure (ex: gpt-4o, gpt-4, gpt-35-turbo)
            ...
            api_key: API key do Azure OpenAI (ou usa AZURE_OPENAI_API_KEY)
            azure_endpoint: Endpoint do Azure OpenAI (ou usa AZURE_OPENAI_ENDPOINT)
            api_version: Versão da API (ou usa AZURE_OPENAI_API_VERSION)
        ...
        # API Version (com valor padrão)
        self.api_version = api_version or os.getenv(
            "AZURE_OPENAI_API_VERSION", "2024-08-01-preview"
        )

        # Inicializar o LLM com AzureChatOpenAI
